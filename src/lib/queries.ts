...
export interface MatchRow {
  ...
  odds_locked?: boolean; allow_repeat_future_bets?: boolean;
...
const matchSelect = `
  id,name,status,start_time,location,is_featured,home_score,away_score,category_id,is_virtual,lock_time,match_kind,marketing_enabled,odds_locked,allow_repeat_future_bets,
